...
上面是我推荐的比赛，即CTF类、算法类、两个数模比赛。其他的就不怎么建议了。比较建议学习CTF+行测申论，以后可以走各省网安特招，即使没进网安特招，学了行测申论也可以去考编和国企笔试。
...
有一定水平之后可以去挖企业src，提交漏洞并通过审核之后会有现金奖励，一个漏洞根据危害等级奖励几百到几万元不等。有些同学在大学期间靠挖src是能挣到挺多钱的，我身边有些同学靠自己的技术挖漏洞，能把自己的生活费学费等都挣出来。挖掘src经历能丰富实战经验还能挣钱，是个不错的选择。
...
四六级一定要过，并且分数尽量高。至少四级一定要过，最好大一就把它过了，四六级考试本身没什么技术含量，努力一下都能过。四六级真的很重要，是一个硬性要求

___

## 关于考证

建议在大学期间考一些认证，如软考证书、CISP-PTE、深信服认证等。要想找网安的好工作，漏洞、渗透、SRC、证书 缺一不可。而且专业证书对于这个行业有一定的重要性。

## 其他

说了这么多，对课程和知识的学习是放在第一位的，没有专业知识的支撑，无法比赛也无法实习也无法写项目。所以建议大家多把时间放在学习网安上，大一的晚自习不至于一直学四级，可能也没那么多课程作业要写，少打会游戏少刷会视频，尽快学习尽快入门，入门之后才能快速进步。水课如果不听的话可以打开网安课程开始学。我们学院的保研数量分配就是按一个班一个名额来算，一个专业如果是两个班，那就是保专业前2，自己不保研就没必要卷绩点了。考试考个六七十，剩余的时间和精力拿来学技术或者考公才对。
...
《对网络安全的思考》：https://blog.zgsec.cn/archives/27.html
